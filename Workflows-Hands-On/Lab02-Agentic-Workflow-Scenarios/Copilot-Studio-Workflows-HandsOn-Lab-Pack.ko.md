...
| 조직 내에서 누군가는 "agent flow", 누군가는 "workflow"라고 말함 | 둘은 **동의어가 아닙니다.** harness도, 캔버스도, 과금도 다릅니다. 헷갈리면 어떤 버튼을 눌렀는지 물어보세요: **New agent flow**(standard) 인지 **New workflow**(GitHub Copilot) 인지. |
